...
namespace srouter::rpc
{
    ...
    struct RPCRequest
    {
      ...
      public:
        ...
        {
            bt = true;
            response_b64.format = srouter::rpc::json_binary_proxy::fmt::bt;
            response_hex.format = srouter::rpc::json_binary_proxy::fmt::bt;
        }
        ...
        //
        srouter::rpc::json_binary_proxy response_hex{response, srouter::rpc::json_binary_proxy::fmt::hex};
        ...
        //
        srouter::rpc::json_binary_proxy response_b64{response, srouter::rpc::json_binary_proxy::fmt::base64};
